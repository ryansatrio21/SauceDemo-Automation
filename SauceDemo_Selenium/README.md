...
Sebelum menjalankan project ini, pastikan Anda sudah menginstall:
* **Java JDK** (Minimal versi 11 atau lebih baru)
* **Maven** (Untuk build dependency)
* **Google Chrome** (Browser terbaru)

## 🚀 How to Run (Cara Menjalankan)

### Opsi 1: Menggunakan Command Line (Terminal/CMD)
...
### Opsi 2: Menggunakan IDE (IntelliJ / Eclipse)
1.  Buka project ini menggunakan IntelliJ IDEA atau Eclipse.
2.  Tunggu hingga Maven selesai mendownload semua dependencies.
3.  Buka file `src/test/java/tests/LoginTest.java`.
4.  Klik kanan pada file tersebut lalu pilih **Run 'LoginTest'**.